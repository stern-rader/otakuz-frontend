  ...
  render() {
    ...
    return (
      ...
      <>
        ...
        <Row>
          <div id='trailer'>
            <iframe width="560" height="315" src={this.state.animeDetails.trailer} title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen autoplay="false" autostart="false" ></iframe>
          </div>
        </Row>
